        ...
        messages: [
          {
            role: "system",
            content:
              "Eres el asistente de WebFlorezia. Responde claro y profesional. Tu objetivo es captar leads (nombre,servicio). explicar el servicio y cerrar la conversación amablemente."
          },
          {
            role: "user",
            content: userMessage,
